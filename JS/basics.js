...
console.log(colors);//[ 'white', 'red', 'orange' ]
console.log(newColors);//[ 'white', 'red', 'orange' ]

const newColors1 = ["pink", "black", ...colors];
const newColors2 = [...colors, "pink", "black"];
const newColors3 = ["yellow", "green", ...colors, "pink", "black"];

console.log(newColors1);//[ 'pink', 'black', 'white', 'red', 'orange' ]
console.log(newColors2);//[ 'white', 'red', 'orange', 'pink', 'black' ]
console.log(newColors3);//['yellow', 'green','white',  'red','orange', 'pink','black']
